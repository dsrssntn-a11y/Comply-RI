  ...
  return (
    <section className="bg-cloud-white border-b border-mist-gray">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <span className="inline-block mt-3 px-2.5 py-1 rounded-full bg-bay-blue/10 text-bay-blue text-xs font-semibold tracking-wide">
          Rhode Island · R.I. Gen. Laws § 23-18.9-17
        </span>
      </div>
    </section>
  );
